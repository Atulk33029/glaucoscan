import os, uuid, time, base64, json, requests
...
# ─────────────────────────────────────────────
# AUTO-DOWNLOAD WEIGHTS FROM GOOGLE DRIVE
# ─────────────────────────────────────────────
WEIGHTS = {
    'models/generator.pth':   '1Hd0QdqZc26PQ172XG-bT6dUpWWSFjRSu',
    'models/classifier.pth':  '1yiL0QuF7rA-S3K5zgMlIo0pOyJ4-LArS',
}
...
def ensure_weights():
    ...
    all_present = all(os.path.exists(p) for p in WEIGHTS)
    if all_present:
...
# Download weights before loading models
ensure_weights()
